...
// Actualizar el estado de una reserva a un valor específico
async function actualizarEstadoReserva(id) {
  ...
  try {
    ...
    // Fijar id_est_reserva a 5 en la actualización
    const query = `
...
async function calificarReserva(req, res) {
  ...
  try {
    console.log('Iniciando la calificación para la reserva:', reservaId); // Debugging
    ...
    // Asegurarnos que la actualización del estado fue exitosa
